      ...
      <div className="flex-1 overflow-y-auto p-5 pb-28 space-y-5 custom-scrollbar">
        ...
        {isLoading && (
          <div className="py-16 flex flex-col items-center justify-center text-accent space-y-4">
            ...
            <p className="font-mono text-sm animate-pulse tracking-wide">
              Analyzing text & generating questions...
            </p>
          </div>
        )}
          ...
          <div className="space-y-6 animate-enter">
            ...
            <div className="bg-success-light rounded-3xl shadow-card border border-success/10 overflow-hidden">
              <div className="px-5 py-4 bg-success/5 border-b border-success/10 flex items-center gap-3">
                ...
                <h3 className="font-display font-bold text-success text-sm">
                  Summary & Explanation
                </h3>
              </div>
              <div className="p-5">
                <MarkdownRenderer
                  ...
                  className="text-ink prose-emerald"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 px-1">
                ...
                <h3 className="font-mono text-[10px] uppercase tracking-[0.15em] text-ink-muted">
                  Study Questions
                </h3>
              </div>
                ...
                >
                  <div className="p-5 bg-surface border-b border-slate-50">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="font-semibold text-ink text-[15px] leading-relaxed pt-0.5">
                        {qa.question}
                      </p>
                    </div>
                  </div>
                  <div className="p-5 bg-slate-50/50">
                    <div className="flex items-start gap-3">
                      <span className="font-mono text-[10px] uppercase tracking-wider text-ink-muted pt-1 shrink-0">
                        Answer:
                      </span>
