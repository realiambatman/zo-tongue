  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col overflow-x-hidden">
      ...
      <section className="relative bg-ink overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 mb-16 lg:mb-0">
            ...
            >
              ...
              <div className="relative w-80 h-80 transform-style-3d animate-rotate-3d z-10">
                ...
                >
                  <svg
                    className="w-24 h-24 text-white stroke-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                    ...
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M3 20.25v-14.25a3 3 0 013-3h12a3 3 0 013 3v14.25a3 3 0 01-3 3H6a3 3 0 01-3-3z"
                    />
                  </svg>
                </div>
                {/* Back - Translate */}
                ...
                >
                  <svg
                    className="w-24 h-24 text-slate-900 stroke-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <svg
                    className="w-24 h-24 text-indigo-600 stroke-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-10 bg-canvas rounded-t-[4rem]"></div>
      </section>

      {/* ========================================
          FEATURES SECTION - Magazine Grid
          ======================================== */}
      <section id="features" className="py-3 bg-canvas">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
