  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col overflow-x-hidden">
      ...
      <section className="relative bg-ink overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20 lg:pt-32 lg:pb-40">
      ...
      <footer className="bg-ink pt-0 pb-0 relative overflow-hidden">
        ...
        <div className="bg-accent py-3 overflow-hidden">
          <div className="animate-marquee flex">
            <span className="text-white font-mono text-sm font-bold tracking-widest mx-4">PAITE • THADOU • HMAR • MIZO • KOM • SIMTE • VAIPHEI • ZOU • GANGTE •</span>
            <span className="text-white font-mono text-sm font-bold tracking-widest mx-4">PAITE • THADOU • HMAR • MIZO • KOM • SIMTE • VAIPHEI • ZOU • GANGTE •</span>
            <span className="text-white font-mono text-sm font-bold tracking-widest mx-4">PAITE • THADOU • HMAR • MIZO • KOM • SIMTE • VAIPHEI • ZOU • GANGTE •</span>
            <span className="text-white font-mono text-sm font-bold tracking-widest mx-4">PAITE • THADOU • HMAR • MIZO • KOM • SIMTE • VAIPHEI • ZOU • GANGTE •</span>
            <span className="text-white font-mono text-sm font-bold tracking-widest mx-4">PAITE • THADOU • HMAR • MIZO • KOM • SIMTE • VAIPHEI • ZOU • GANGTE •</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="flex flex-col justify-between h-full">
              <div>
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-ink font-display font-bold text-2xl mb-8">
                  Z
                </div>
                <h3 className="font-display text-4xl lg:text-5xl font-bold text-white leading-tight mb-8">
                  Bridging worlds,<br/>one word at a time.
                </h3>
                <p className="text-slate-400 text-lg font-light max-w-md leading-relaxed">
                  The first comprehensive AI platform dedicated to the preservation and evolution of the Zo languages.
                </p>
              </div>
              ...
              <div className="mt-12 lg:mt-0">
                 ...
                 <div className="flex gap-4">
                    {/* Social Icons */}
                    <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-white hover:text-ink transition-all duration-300">
            ...
            <div className="flex flex-col gap-2 mt-12 lg:mt-0">
               <h4 className="text-slate-500 font-mono text-xs uppercase tracking-widest mb-6 border-b border-slate-800 pb-4">Index</h4>
               {[
                  { label: "Native Chat", mode: AppMode.CHAT, num: "01" },
                  { label: "Deep Translate", mode: AppMode.TRANSLATE, num: "02" },
        ...
        <div className="border-t border-slate-800 bg-black/20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
             ...
             <div className="flex gap-6">
               <a href="#" className="text-slate-500 hover:text-white text-xs font-mono uppercase tracking-wider transition-colors">Privacy</a>
               <a href="#" className="text-slate-500 hover:text-white text-xs font-mono uppercase tracking-wider transition-colors">Terms</a>
             </div>
          </div>
        </div>
      </footer>
